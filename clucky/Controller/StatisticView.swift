...
class StatisticView: UIViewController, SlideMenuDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationBar.setBackgroundImage(UIImage(named: "statisticNavImage"), for: .default)
